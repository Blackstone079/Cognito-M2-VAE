...
def main() -> None:
    ...
    with in_csv.open('r', newline='', encoding='utf-8') as f:
        ...
        for row in r:
            ...
            if mol is None:
                continue
            X_fp[idx, :] = morgan_fp(mol, n_bits=fp_bits, radius=fp_radius, count_simulation=fp_count_simulation, include_chirality=fp_include_chirality)
            idx += 1
    if idx != N:
