...
def main() -> None:
    ...
    feature_representation = {
        'd_fp': int(features_meta.get('d_fp', 0)),
        'd_desc': int(features_meta.get('d_desc', 0)),
        'desc_panel': features_meta.get('desc_panel'),
        'desc_names': features_meta.get('desc_names', []),
        'fp_radius': features_meta.get('fp_radius'),
        'fp_count_simulation': bool(features_meta.get('fp_count_simulation', False)),
        'fp_include_chirality': bool(features_meta.get('fp_include_chirality', False)),
    }
